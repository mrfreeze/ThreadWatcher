...
#import "WKApplicationGlue.h"

@implementation WKApplication
...
- (id)initWithTargetType:(ASTargetType)targetType_ data:(id)targetData_ {
    ...
    appData = [[ASAppData alloc] initWithApplicationClass: [AEMApplication class]
                                            constantClass: [WKConstant class]
                                           referenceClass: [WKReference class]
...
- (WKReference *)AS_referenceWithObject:(id)object {
    if ([object isKindOfClass: [WKReference class]])
        return [[[WKReference alloc] initWithAppData: AS_appData
