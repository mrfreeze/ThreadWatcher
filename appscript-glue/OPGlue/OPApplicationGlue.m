...
- (id)initWithTargetType:(ASTargetType)targetType_ data:(id)targetData_ {
    ...
    appData = [[ASAppData alloc] initWithApplicationClass: [AEMApplication class]
                                            constantClass: [OPConstant class]
                                           referenceClass: [OPReference class]
...
- (OPReference *)AS_referenceWithObject:(id)object {
    if ([object isKindOfClass: [OPReference class]])
        return [[[OPReference alloc] initWithAppData: AS_appData
